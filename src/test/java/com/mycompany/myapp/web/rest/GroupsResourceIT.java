...
class GroupsResourceIT {
    ...
    private static final Integer DEFAULT_NOW_SIZE = 1;
    private static final Integer UPDATED_NOW_SIZE = 2;
    ...
    public static Groups createEntity(EntityManager em) {
        Groups groups = new Groups().groupName(DEFAULT_GROUP_NAME).capacity(DEFAULT_CAPACITY).nowSize(DEFAULT_NOW_SIZE);
        return groups;
    }
    ...
    public static Groups createUpdatedEntity(EntityManager em) {
        Groups groups = new Groups().groupName(UPDATED_GROUP_NAME).capacity(UPDATED_CAPACITY).nowSize(UPDATED_NOW_SIZE);
        return groups;
    }
    ...
    void createGroups() throws Exception {
        ...
        assertThat(testGroups.getNowSize()).isEqualTo(DEFAULT_NOW_SIZE);
    }
    ...
    void getAllGroups() throws Exception {
        ...
        restGroupsMockMvc
            ...
            .andExpect(jsonPath("$.[*].nowSize").value(hasItem(DEFAULT_NOW_SIZE)));
    }
    ...
    void getGroups() throws Exception {
        ...
        restGroupsMockMvc
            ...
            .andExpect(jsonPath("$.nowSize").value(DEFAULT_NOW_SIZE));
    }
    ...
    void putNewGroups() throws Exception {
        ...
        updatedGroups.groupName(UPDATED_GROUP_NAME).capacity(UPDATED_CAPACITY).nowSize(UPDATED_NOW_SIZE);
        ...
        assertThat(testGroups.getNowSize()).isEqualTo(UPDATED_NOW_SIZE);
    }
    ...
    void partialUpdateGroupsWithPatch() throws Exception {
        ...
        partialUpdatedGroups.capacity(UPDATED_CAPACITY).nowSize(UPDATED_NOW_SIZE);
    ...
    void fullUpdateGroupsWithPatch() throws Exception {
        ...
        partialUpdatedGroups.groupName(UPDATED_GROUP_NAME).capacity(UPDATED_CAPACITY).nowSize(UPDATED_NOW_SIZE);
    ...
    void deleteGroups() throws Exception {
        ...
        // Delete the groups
        restGroupsMockMvc
            .perform(delete(ENTITY_API_URL_ID, groups.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
